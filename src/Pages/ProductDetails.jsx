...
const ProductDetails = () => {
  ...
  const findProductById = products.filter(
    ...
    <div className="flex justify-center items-center min-h-[80vh] px-4">
      {findProductById.map(
        ({
          ...
          <div
            key={id}
            className="card lg:card-side bg-base-100 shadow-lg border border-gray-200 transition-transform duration-300 ease-linear hover:scale-[102%] max-w-4xl"
          >
            {/* Product Image */}
